...
export const Inventory = () => {
  ...
  const checkIfInventoryExists = async (inventoryName) => {
    try {
      const response = await axios.get(`https://test.ubsbill.com/apptest/sys/Inventory/inventory/${currentuser.storeid}`);
...
export const Update_Inventory = () => {
  ...
  useEffect(() => {
    axios
      .get("https://test.ubsbill.com/apptest/sys/Inventory/getInventoryByID/" + id)
      .then((res) => {
        setValues({
          ...values,
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch("https://test.ubsbill.com/apptest/sys/Inventory/updateinventory/" + id, updatedInventory)
      .then((res) => {
...
export const Inventory_list = () => {
  ...
  const fetchData = () => {
    const url = `https://test.ubsbill.com/apptest/sys/Inventory/inventory/${currentuser.storeid}`;
...
const handleGeneratePDF = async () => {
  ...
  url = `https://test.ubsbill.com/apptest/sys/Inventory/generate-pdf-inventory/?storeid=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
  }else{
  // If start or end date is not selected, construct the URL without date range
  url = `https://test.ubsbill.com/apptest/sys/Inventory/generate-pdf-inventory/${currentuser.storeid}`;
  }
  ...
  //       `https://test.ubsbill.com/apptest/sys/Inventory/excelInventory/?storeid=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`,
  //       null,
  //       {
  //         responseType: "blob",
  //       }
  ...
  const generateExcel = async () => {
    try {
     ...
     if (formattedStartDate && formattedEndDate) {
        // If both start and end dates are selected, construct the URL with date range
        url = `https://test.ubsbill.com/apptest/sys/Inventory/excelInventory/?storeid=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
     } else {
        // If start or end date is not selected, construct the URL without date range
        url = `https://test.ubsbill.com/apptest/sys/Inventory/generateExcel/${currentuser.storeid}`;
     }
