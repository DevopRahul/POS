  ...
  handleSendOTP = (e) => {
    ...
    axios
     ...
     .catch((error) => {
        ...
        axios
        .post("https://test.ubsbill.com/apptest/api/auth/Tech/forgot-password", {
         email: email, // Use the email from state
        })
        .then((response) => {
         console.log("OTP Send Successfully");
        ...
        .catch((error) => {
         ...
         axios
         .post("https://test.ubsbill.com/apptest/api/auth/user/user-forgot-password", {
            email: email, // Use the email from state
         })
         .then((response) => {
            console.log("OTP Send Successfully");
          ...
          <div className="card border-info">
            ...
            >
              ...
              <div className="form-group">
                <button
                  className="btn btn-block text-white" style={{ backgroundColor: "#03989e",fontSize:"2vh" }}
                >
