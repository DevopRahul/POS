...
const VendorInventory = () => {
  ...
  const checkDuplicateAssociation = (vendorName, itemName) => {
    return axios
      .get(
        `https://test.ubsbill.com/apptest/sys/VendorInventory/checkDuplicate?vendor_name=${vendorName}&item_name=${itemName}`
      )
  ...
  const fetchVendorList = async () => {
    try {
      const response = await axios.get(
        `https://test.ubsbill.com/apptest/sys/Vendor/vendor/${currentuser.storeid}`
...
useEffect(() => {
 ...
 const updateTotal = (e) => {
  ...
  const calculatedTotal = calculateTotal(updatedInvoice);
  setInvoice({ ...updatedInvoice, total: calculatedTotal });
  };
...
export const Update_Vendor_Inventory = () => {
  ...
  useEffect(() => {
    axios
      .get("https://test.ubsbill.com/apptest/sys/VendorInvoice/getInvoiceByID/" + id)
      .then((res) => {
        setValues({
          ...values,
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch("https://test.ubsbill.com/apptest/sys/VendorInvoice/updateinvoice/" + id, {
        ...values,
