...
// Neha Made chnages in fetchStores function to set the list in descending order
  ...
  useEffect(() => {
    axios
      .get(
        `https://test.ubsbill.com/apptest/api/auth/Tech/Tech/${editStore.techid}`
      )
      .then((res) => {
        setEditStore({
          ...editStore,
  ...
  const handleSaveEdit = (e) => {
    ...
    axios
      .patch(
        `https://test.ubsbill.com/apptest/api/auth/Tech/updatetech/${editStore.techid}`,
        formData
      )
      .then((res) => {
        // Handle success
  ...
  const generatePDF = async () => {
    try {
      ...
      const response = await axios.get(`https://test.ubsbill.com/apptest/api/auth/Tech/gettech`);
...
const fetchDataByDateRange = () => {
  ...
  const url = `https://test.ubsbill.com/apptest/api/auth/Tech/gettech`;
