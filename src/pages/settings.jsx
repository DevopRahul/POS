...
useEffect(() => {
    axios
     .get(
        `https://test.ubsbill.com/apptest/api/auth/store/getstore/${currentuser.storeid}`
     )
     .then((res) => {
        setValues({
         ...values,
...
const handleSubmit = async (e) => {
  ...
  if (!values.username.trim()) {
    // Show a toast message indicating the username is required
  ...
  try {
    const response = await axios.patch(
      `https://test.ubsbill.com/apptest/api/auth/store/updatestore/${currentuser.storeid}`,
      formData
    );
...
export const Super_setting = () => {
  ...
  useEffect(() => {
      axios
       .get(
          `https://test.ubsbill.com/apptest/api/auth/SuperAdmin/updatesuperadmin/${currentuser.superid}`
       )
       .then((res) => {
          setValues({
           ...values,
  ...
  const handleSubmit = (e) => {
      ...
      axios
       .patch(
          `https://test.ubsbill.com/apptest/api/auth/SuperAdmin/updatetsuper/${currentuser.superid}`,
          formData
       )
       .then((res) => {
          // Handle success
...
export const Tech_setting = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://test.ubsbill.com/apptest/api/auth/Tech/stores/${currentuser.techid}`
      )
      .then((res) => {
        setValues({
          ...values,
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch(
        `https://test.ubsbill.com/apptest/api/auth/Tech/updatetech/${currentuser.techid}`,
        formData
      )
      .then((res) => {
        // Handle success
...
export const Payment_setting = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://test.ubsbill.com/apptest/sys/api/store-payments/save", formData)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://test.ubsbill.com/apptest/sys/api/store-payments/storepayment/${currentuser.storeid}`
      )
      .then((response) => {
  ...
  const handleDelete = (paymentId) => {
    ...
    axios
      .delete(
        `https://test.ubsbill.com/apptest/sys/api/store-payments/deletestorepayment/${paymentId}`
      )
      .then((response) => {
  ...
  const handleEditSubmit = (event) => {
    ...
    axios
      .patch(
        `https://test.ubsbill.com/apptest/sys/api/store-payments/updatestorepayment/${editingPaymentId}`,
        formData
      )
      .then((response) => {
    ...
    <div className="p-5 animation" style={{marginTop:"5vh"}}>
     <div className="row" style={{ marginTop: "5vh" }}>
        <div className="col-md-10" style={{ margin: "auto" }}>
         <div
            className="card mt-3"
            style={{ margin: "auto", width: "70vw", color: "black" }}
         >
         <div className="card-header fs-3 text-left">
            ...
            <div className="card-body" style={{ width: "70vw" }}>
             <table class="table`1" style={{ width: "65vw" }}>
                <thead style={{ fontSize: "1vw" }}>
                  <tr style={{ fontSize: "1vw", color: "black" }}>
                    <th scope="col" className="px-2">Sr.No</th>
                    <th scope="col" className="px-2">Store Name</th>
                    <th scope="col" className="px-2">Bank Name</th>
                    <th scope="col" className="px-2">Account No</th>
                    <th scope="col" className="px-2">IFSC Code</th>
                    <th scope="col" className="px-2">UPI ID</th>
                ...
                <tbody>
                  {paymentList.map((payment, index) => (
                    <tr key={index} style={{ fontSize: "2vh" }}>
                      <td>{index + 1}</td>
                      <td className="text-dark px-2">
                        {payment.store_name}
                      </td>
                      <td className="px-2">{payment.bankName}</td>
                      <td className="px-2">{payment.accountNo}</td>
                      <td className="px-2">{payment.ifscCode}</td>
                      <td className="px-2">{payment.upiId}</td>
                      <td className="px-2" style={{ display: "flex" }}>
                  ...
                  {showAlerts[payment.serial_no] && (
                   <div className="overlay" style={{top:"30%"}}>
...
const Taxsetting = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://test.ubsbill.com/apptest/sys/Tax/stores/${currentuser.storeid}/taxes`
      );
  ...
  const deleteTax = (serial_no) => {
    const apiUrl = "https://test.ubsbill.com/apptest/sys/Tax/taxes/" + serial_no;
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://test.ubsbill.com/apptest/sys/Tax/save", formData)
      .then((response) => {
...
export const Update_Tax = () => {
  ...
  useEffect(() => {
    axios
      .get("https://test.ubsbill.com/apptest/sys/Tax/gettaxbyid/" + id)
      .then((res) => {
        setValues({
          ...values,
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .patch("https://test.ubsbill.com/apptest/sys/Tax/update/" + id, values) // rushikesh made this changes accepet
      .then((res) => {
  ...
  return (
    ...
    Update
         ...
         <ToastContainer
            position="top-right"
            autoClose={1000}
            style={{marginTop:"10vh",marginleft:"-10vh"}}
            limit={1}
            hideProgressBar={false}
            newestOnTop={false}
            closeOnClick
