...
export const Roleaccess = () => {
  ...
  useEffect(() => {
    fetch(
      `https://test.ubsbill.com/apptest/api/auth/user/byStoreId/${currentuser.storeid}`
    )
      .then((data) => data.json())
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://test.ubsbill.com/apptest/sys/UserSidebar/save",
        {
          method: "POST",
          headers: {
...
export const Updateroleaccess = () => {
  ...
  useEffect(() => {
    fetch(
      `https://test.ubsbill.com/apptest/sys/UserSidebar/store/${currentuser.storeid}/users`
    )
      .then((data) => data.json())
      .then((val) => setMenus(val));
  }, []);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://test.ubsbill.com/apptest/sys/UserSidebar/UserSidebar",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
