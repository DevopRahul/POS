...
url = `https://test.ubsbill.com/apptest/sys/Bill/total-payment-amount-pdf/?storeId=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
}else{
// If start or end date is not selected, construct the URL without date range
url = `https://test.ubsbill.com/apptest/sys/Bill/total-payment-amount-pdf/${currentuser.storeid}`;
}
...
responseType: "blob",
     ...
     a.href = downloadUrl;
     a.download = 'Daily-income-details.pdf';
     a.click();
