...
export const CategoryButton = () => {
    ...
    const checkIfcategoryExists = async (butName) => {
      try {
        const response = await axios.get(`https://test.ubsbill.com/apptest/sys/Button/getbutton/${currentuser.store_id}`);
    ...
    const handleDeletedCategory = (id) => {
      ...
      const handleEditSubmit = (event) => {
        ...
        axios.patch(`https://test.ubsbill.com/apptest/sys/Button/updateButton/${editingCategoryId}`, category)
        .then((response) => {
      ...
      const fetchCategoryDetails = () => {
        ...
        axios
          .get(
            `https://test.ubsbill.com/apptest/sys/Button/getbutton/${currentuser.storeid}`
          )
          .then((response) => {
