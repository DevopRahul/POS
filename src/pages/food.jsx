...
// ---end --------
  ...
  const formData = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://test.ubsbill.com/apptest/sys/Food/addfoods",
        formData,
        {
          headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://test.ubsbill.com/apptest/sys/Food/upload",
        formData
      );
  ...
  const fetchCategoryList = async () => {
    try {
      const response = await axios.get(`https://test.ubsbill.com/apptest/sys/Button/getbutton/${currentuser.storeid}`); // Replace with your API endpoint
...
export const Update_food = () => {
  ...
  useEffect(() => {
      axios
       .get("https://test.ubsbill.com/apptest/sys/Food/getFoodByID/" + id)
       .then((res) => {
          setValues({
           ...values,
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .patch(`https://test.ubsbill.com/apptest/sys/Food/updatefood/` + id, formData)
      .then((res) => {
        // Handle success
...
export const Food_list = () => {
  ...
  const generateExcel = async () => {
    try {
      const response = await axios.post(
        `https://test.ubsbill.com/apptest/sys/Food/generateExcel/${currentuser.storeid}`,
        null,
        {
