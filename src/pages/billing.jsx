...
export const Billing = () => {
  ...
  const [discount, setDiscount] = useState("");
   ...
   const generateQRCode = async () => {
      try {
         // const response = await fetch(`https://test.ubsbill.com/apptest/sys/api/store-payments/generateQRCode?text=${upiId}`);
         const response = await fetch(`https://test.ubsbill.com/apptest/sys/api/store-payments/generateQRCode?text=${upi}`);
         if (response.ok) {
