...
export const ProductForm = () => {
  ...
  const fetchInventoryList = async () => {
    try {
      const response = await axios.get(
        `https://test.ubsbill.com/apptest/sys/Inventory/inventory/${currentuser.storeid}`
      ); // Replace with your API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://test.ubsbill.com/apptest/sys/fooditems/getfood/${currentuser.storeid}`
      );
      ...
      const postResponse = await axios.post(
        "https://test.ubsbill.com/apptest/sys/fooditems/addfood",
        productData
      );
...
export const Update_Recipe = () => {
  ...
  useEffect(() => {
    axios
      .get("https://test.ubsbill.com/apptest/sys/fooditems/getbyid/" + id)
      .then((res) => {
        setValues({
          ...values,
          id: res.data.id,
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .patch("https://test.ubsbill.com/apptest/sys/fooditems/updatefood/" + id, values)
      .then((res) => {
...
export const Receipe_list = () => {
  ...
  const fetchData = () => {
    fetch(`https://test.ubsbill.com/apptest/sys/fooditems/getfood/${currentuser.storeid}`)
  ...
  const fetchDataByDateRange = () => {
    ...
    const url = `https://test.ubsbill.com/apptest/sys/fooditems/getfood/${currentuser.storeid}`;
...
{showAlerts[recipe.ser_no] && (
            ...
            <a href="/receipe" className="btn btn-outline-primary boton" style={{
  fontSize: "2vh",
  height: "5vh",
  marginRight: "5px",
}}>
