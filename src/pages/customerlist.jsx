...
export const Customer_list = () => {
    ...
    const fetchData = () => {
      const url = `https://test.ubsbill.com/apptest/sys/customer/getcustomer/${currentuser.storeid}`;
    ...
    const handleGeneratePDF = async () => {
      try {
       ...
       if (formattedStartDate && formattedEndDate) {
          ...
          url = `https://test.ubsbill.com/apptest/sys/customer/generate-pdf-customer/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
       } else {
          // If start or end date is not selected, construct the URL without date range
          url = `https://test.ubsbill.com/apptest/sys/customer/generate-pdf-customer/${currentuser.storeid}`;
       }
       ...
       a.href = downloadUrl;
       a.download = 'Customer-details.pdf';
       a.click();
    ...
    return (
      <div className="data animation">
        ...
        <div class="content read">
          ...
          <div className="no-data-message"  style={{marginLeft:"25vh"}}>No Customer data available.</div>
        ) : (
