  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://test.ubsbill.com/apptest/api/auth/store/reset-password",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        const response = await fetch(
          "https://test.ubsbill.com/apptest/api/auth/user/user-reset-password",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
...
>
            ...
            <div className="form-group text65">
              <div className="input-group">
               ...
               <div className="password-input">
                    <div className="input-container"  style={{width:"40vh", height: "5vh"}}>
                      <input
            ...
            <div className="form-group text65">
              <div className="input-group">
                <div className="form-group">
                  <div className="password-input">
                  <div className="input-container"  style={{width:"40vh",
                      height: "5vh",marginTop: "-17px"}}>
                    <input
