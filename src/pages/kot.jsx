...
const fetchRunningOrders = () => {
    ...
    fetch(`https://test.ubsbill.com/apptest/sys/Bill/billorder/${currentuser.storeid}?ordstatus=Running`)
...
axios
    .patch(`https://test.ubsbill.com/apptest/sys/order/updateorderStatus/${orderId}`, { status: 'Prepared' })
    .then((res) => {
