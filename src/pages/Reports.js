...
export const Vendor_list = () => {
  ...
  const fetchData = () => {
    const url = `https://test.ubsbill.com/apptest/sys/Vendor/vendor/${currentuser.storeid}`;
...
// If both start and end dates are selected, construct the URL with date range
url = `https://test.ubsbill.com/apptest/sys/Vendor/generate-pdf-vendor/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
}else{
// If start or end date is not selected, construct the URL without date range
url = `https://test.ubsbill.com/apptest/sys/Vendor/generate-pdf-vendor/${currentuser.storeid}`;
}
    ...
    const isDateInRange = (date, startDate, endDate) => {
      ...
      const generateExcel = async () => {
        try {
         ...
         if (formattedStartDate && formattedEndDate) {
            // If both start and end dates are selected, construct the URL with date range
            url = `https://test.ubsbill.com/apptest/sys/Vendor/excelvendor/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
         } else {
            // If start or end date is not selected, construct the URL without date range
            url = `https://test.ubsbill.com/apptest/sys/Vendor/getvendorlist/${currentuser.storeid}`;
         }
...
export const Payment_list = () => {
  ...
  const fetchData = () => {
    const url = `https://test.ubsbill.com/apptest/sys/Payment/payments/${currentuser.storeid}`;
  ...
  const generateExcel = async () => {
    try {
     ...
     if (formattedStartDate && formattedEndDate) {
        // If both start and end dates are selected, construct the URL with date range
        url = `https://test.ubsbill.com/apptest/sys/Payment/excelpayment/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
     } else {
        // If start or end date is not selected, construct the URL without date range
        url = `https://test.ubsbill.com/apptest/sys/Payment/excelpayment/${currentuser.storeid}`;
     }
...
if(formattedStartDate && formattedEndDate){
// If both start and end dates are selected, construct the URL with date range
url = `https://test.ubsbill.com/apptest/sys/Payment/generate-pdf-payment/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
}else{
// If start or end date is not selected, construct the URL without date range
url = `https://test.ubsbill.com/apptest/sys/Payment/generate-pdf-payment/${currentuser.storeid}`;
}
const response = await axios.post(url, null, {
responseType: "blob",
});
...
export const Vendor_Invoice_List = () => {
  ...
  const fetchData = () => {
    const url = `https://test.ubsbill.com/apptest/sys/VendorInvoice/invoices/${currentuser.storeid}`;
...
if(formattedStartDate && formattedEndDate){
// If both start and end dates are selected, construct the URL with date range
url = `https://test.ubsbill.com/apptest/sys/VendorInvoice/generate-pdf-invoice/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
}else{
// If start or end date is not selected, construct the URL without date range
url = `https://test.ubsbill.com/apptest/sys/VendorInvoice/generate-pdf-invoice/${currentuser.storeid}`;
}
const response = await axios.post(url, null, {
responseType: "blob",
});
     ...
     const a = document.createElement('a');
     a.href = downloadUrl;
     a.download = 'vendor_inventory-details.pdf';
     a.click();
...
const generateExcel = async () => {
  try {
   ...
   if (formattedStartDate && formattedEndDate) {
      // If both start and end dates are selected, construct the URL with date range
      url = `https://test.ubsbill.com/apptest/sys/VendorInvoice/excelinvoicedate/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
   } else {
      // If start or end date is not selected, construct the URL without date range
      url = `https://test.ubsbill.com/apptest/sys/VendorInvoice/excelinvoice/${currentuser.storeid}`;
   }
    ...
    <div className="data p-5 animation">
      ...
      {showAlerts[invoice.serial_no] && (
           ...
           <button
             ...
             onClick={() => {
                // Add the functionality you want when the button is clicked
                window.location.href = "/VendorInventory";
             }}
            >
             <i className="fas fa-plus" style={{ marginRight: "5px" }}></i>
             <span style={{ textDecoration: "none", color: "inherit" }}>
      ...
      <div class="content read">
        ...
        <div className="no-data-message" style={{marginLeft:"20vh"}}>No Vendor Inventory data available.</div>
      ) : (
          <tbody className="tbodytr">
...
export const Balance_list = () => {
  ...
  const fetchBalanceList = () => {
    const url = `https://test.ubsbill.com/apptest/sys/api/balance/balance/${currentuser.storeid}`;
  ...
  const fetchTransactionData = (date) => {
    const apiUrl = `https://test.ubsbill.com/apptest/sys/transaction/transaction/${currentuser.storeid}`;
    //const apiUrl = `https://test.ubsbill.com/apptest/sys/transaction/transactions-by-date?date=${date}`;
    fetch(apiUrl)
      .then((response) => {
        if (!response.ok) {
  ...
  const fetchPaymentData = () => {
    ...
    fetch(`https://test.ubsbill.com/apptest/sys/Bill/daily-cash-balance-report`)
    ...
    fetch(`https://test.ubsbill.com/apptest/sys/Bill/daily-card-balance-report`)
    ...
    fetch(`https://test.ubsbill.com/apptest/sys/Bill/daily-upi-balance-report`)
  ...
  const fetchCashTotalData = () => {
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/daily-cash-balance-report/${currentuser.storeid}`
    )
      .then((response) => response.json())
      .then((json) => {
        setCashTotals(json);
  ...
  const fetchCardTotalData = () => {
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/daily-card-balance-report/${currentuser.storeid}`
    )
      .then((response) => response.json())
      .then((json) => {
        setCardTotals(json);
  ...
  const fetchUpiTotalData = () => {
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/daily-upi-balance-report/${currentuser.storeid}`
    )
      .then((response) => response.json())
      .then((json) => {
        setUpiTotals(json);
  ...
  const fetchData = () => {
    fetch(
      `https://test.ubsbill.com/apptest/sys/api/balance/balance/${currentuser.storeid}`
    )
      .then((response) => response.json())
      .then((json) => {
        setBalanceList(json);
...
const handleGeneratePDF = async () => {
  ...
  if(formattedStartDate && formattedEndDate){
  // If both start and end dates are selected, construct the URL with date range
  url = `https://test.ubsbill.com/apptest/sys/transaction/generate-pdf-transaction/?store_id=${currentuser.storeid}&startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
  }else{
  // If start or end date is not selected, construct the URL without date range
  url = `https://test.ubsbill.com/apptest/sys/transaction/generate-pdf-transaction/${currentuser.storeid}`;
  }
  const response = await axios.post(url, null, {
  responseType: "blob",
  });
      ...
      const a = document.createElement('a');
      a.href = downloadUrl;
      a.download = 'Cash-register-details.pdf';
      a.click();
    ...
    <div className="data animation">
      ...
      {balanceList.length === 0 ? ( // Check if the list is empty
        ...
        <table>
          ...
          {balanceList.length === 0 ? ( // Check if the list is empty
        <div className="no-data-message"  style={{marginLeft:"15vh"}}>No Cash register data available.</div>
      ) : (
              <tbody className="tbodytr">
