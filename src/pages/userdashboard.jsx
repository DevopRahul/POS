...
function UserDashboard() {
   ...
   useEffect(() => {
      ...
      axios
         .get(
            `https://test.ubsbill.com/apptest/sys/Bill/total-payments/${currentuser.storeid}/today`
         )
         .then((response) => {
   ...
   useEffect(() => {
      axios
         .get(`https://test.ubsbill.com/apptest/sys/OrderFood/food-quantity/${currentuser.storeid}`)
         .then((response) => {
   ...
   useEffect(() => {
      async function fetchData() {
         try {
            const response = await fetch('https://test.ubsbill.com/apptest/sys/notification/last24');
            if (!response.ok) {
