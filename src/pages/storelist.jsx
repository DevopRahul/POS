...
function StoreList() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://test.ubsbill.com/apptest/api/auth/store/stores/${editStore.storeId}`
      )
      .then((res) => {
        setEditStore({
          ...editStore,
  ...
  const handleSaveEdit = (e) => {
    ...
    axios
      .patch(
        `https://test.ubsbill.com/apptest/api/auth/store/updatestore/${editStore.storeId}`,
        formData
      )
      .then((res) => {
        // Handle success
  ...
  const generatePDF = async () => {
    try {
      ...
      const response = await axios.get(`https://test.ubsbill.com/apptest/api/auth/store/admin/allstores`);
  ...
  const fetchDataByDateRange = () => {
    ...
    const url = `https://test.ubsbill.com/apptest/api/auth/store/admin/allstores`;
  ...
  const handleGeneratePDF = async () => {
    try {
      const response = await axios.get('https://test.ubsbill.com/apptest/api/auth/store/generate-pdf', {
