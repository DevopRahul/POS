...
const Payment = () => {
  ...
  const fetchVendorList = async () => {
    try {
      const response = await axios.get(`https://test.ubsbill.com/apptest/sys/Vendor/vendor/${currentuser.storeid}`); // Replace with your API endpoint
  ...
  const fetchItemNames = async () => {
    try {
      const response = await axios.get(`https://test.ubsbill.com/apptest/sys/Inventory/inventory/${currentuser.storeid}`); // Replace with your API endpoint for fetching item names
...
export const Update_payment = () => {
  ...
  useEffect(() => {
    axios
      .get("https://test.ubsbill.com/apptest/sys/Payment/" + id)
      .then((res) => {
        setValues({
          ...values,
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch("https://test.ubsbill.com/apptest/sys/Payment/updatePayment/" + id, values)
      .then((res) => {
...
const formattedDate = `${year}-${month}-${day}`;
  const [values, setValues] = useState({
    ...
    payment_date: formattedDate, // Add this line
  ...
  const generateQRCode = async () => {
    try {
      const response = await fetch(`https://test.ubsbill.com/apptest/sys/Payment/generateQRCode/${id}`);
      if (response.ok) {
