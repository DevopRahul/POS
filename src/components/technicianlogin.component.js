...
const required = value => {
  if (!value) {
    return (
      <div className="alert alert-danger" role="alert"  style={{height:"vh",fontSize:"2vh"}}>
      ...
      .then(() => {
        toast.success('Login successful', {
           ...
           onClose: () => {
            ...
            // Do not reload the window immediately here
           }
        });
       })
       .catch(error => {
...
resetHandler = () => {
  ...
  render() {
    return (
      ...
      <div className="card">
         <h4 className="text-center text-info mt-6 text23"style={{fontSize:"3.5vh",fontWeight:"700"}}><i class="fa-solid fa-user-gear"></i> Technician Login</h4>
         <Form className="p-2"
    ...
    <div className="text-center">
        {this.state.loading && (
         ...
         <div className="mt-2 text-center text25">
            <Link to="/techforgotpassword" className="text-decoration-none text-info">
               Forgot Password?
            </Link>
