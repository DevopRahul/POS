...
function BalanceForm() {
  ...
  const handleRegister = async (e) => {
    ...
    if (!addmoreamounts.trim() || addmoreamounts < 1) {
     ...
     const response = await axios.patch(
        "https://test.ubsbill.com/apptest/sys/api/balance/start-new-day",
        formData
     );
  ...
  useEffect(() => {
    ...
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/total-cash-amount/${currentuser.storeid}/today`
    )
    ...
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/total-card-amount/${currentuser.storeid}/today`
    )
    ...
    // Fetch UPI payment
    fetch(
      `https://test.ubsbill.com/apptest/sys/Bill/total-upi-amount/${currentuser.storeid}/today`
    )
  ...
  const handleSubmitexpense = (e) => {
    ...
    fetch("https://test.ubsbill.com/apptest/sys/transaction/end-of-day-close", {
      method: "POST",
      headers: {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://test.ubsbill.com/apptest/sys/api/balance/addBalance", formData)
      .then((response) => {
        // Handle the response
  ...
  const fetchClosingBalance = () => {
    ...
    const apiUrl = `https://test.ubsbill.com/apptest/sys/api/balance/total-closing-balance`;
  ...
  const fetchcurrentClosingBalance = () => {
    // Define the URL for your closing balance API endpoint
    // const apiUrl = `https://test.ubsbill.com/apptest/sys/api/balance/balance/${currentuser.storeid}`;
    const apiUrl = `https://test.ubsbill.com/apptest/sys/api/balance/yesterday-closing-balance/${currentuser.storeid}`;
    ...
    const fetchRemainingBalance = async () => {
      try {
        const response = await fetch(
          `https://test.ubsbill.com/apptest/sys/api/balance/remaining_balance/${currentuser.storeid}`
        );
        if (response.ok) {
